...
import com.axity.arquetipo.commons.response.graphql.CustomerGraphlQLDto;
import com.axity.arquetipo.commons.response.graphql.EmployeeGraphQLDto;
import com.axity.arquetipo.model.EmployeeDO;
...
public final class EmployeeResponseDtoTransformer
{
  ...
  /**
   * Transforma una entidad {@link com.axity.arquetipo.model.EmployeeDO} en un dto
   * {@link com.axity.arquetipo.commons.response.graphql.EmployeeGraphQLDto}
   * 
   * @param entity
   * @param query
   * @return
