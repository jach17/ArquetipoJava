package com.[%= company %].[%= name %].commons.aspectj;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
  ...
  @Around("execution (* com.[%= company %].[%= name %].controller.*.*(..))"
      + " and @annotation(com.[%= company %].[%= name %].commons.aspectj.JsonResponseInterceptor)")
